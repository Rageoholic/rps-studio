...
use ash::vk::{
    ...
    DebugUtilsMessengerCallbackDataEXT, DebugUtilsMessengerEXT, DeviceCreateInfo,
    DeviceQueueCreateInfo, PhysicalDeviceFeatures2, PhysicalDeviceVulkan12Features,
    PhysicalDeviceVulkan13Features, QueueFlags, SurfaceKHR,
};
use clap::Parser;
use thiserror::Error;
...
impl Instance {
    ...
    fn enumerate_physical_devices(&self) -> ash::prelude::VkResult<Vec<vk::PhysicalDevice>> {
